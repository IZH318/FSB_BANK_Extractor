...
- **GUI 버전 개선 사항**
   ...
   - **실시간 검색 및 필터링:** 
       - 디바운스(Debounce) 타이머가 적용된 검색창을 통해, 수천 개의 오디오 노드 중 이름이 일치하는 항목만 리스트 형태로 필터링하여 보여줍니다.
   - **통합 상세 정보 패널:** 
...
GUI 버전이 단순한 '추출기'를 넘어, **'FMOD 오디오 종합 분석 도구'** 로 새롭게 개편되었습니다. **(CLI 버전은 변경 사항 없음)**
...
-   #### **⚡ 성능 및 최적화**
    ...
    -   **검색 최적화**: 입력 지연(Debounce) 타이머를 적용하여 검색어 입력 시 불필요한 연산을 줄이고 반응 속도를 높였습니다.
